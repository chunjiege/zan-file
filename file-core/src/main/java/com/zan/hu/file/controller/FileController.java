...
import com.zan.hu.file.model.request.BatchDeleteRequest;
...
public class FileController {
    ...
    public String singleUpload(@RequestParam(value = "file") MultipartFile file) {
    ...
    public void batchDelete(@RequestBody BatchDeleteRequest batchDeleteRequest) {
        Assert.notNull(batchDeleteRequest, "entity must not null");
        Assert.notEmpty(batchDeleteRequest.getObjectIds(), "the given id must not null ");
        fileService.batchDelete(batchDeleteRequest.getObjectIds());
    }
